        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              ...
              >
                <p className="label-caps mb-2" style={{ color: 'var(--muted)' }}>
                  {t('home_invest_min_label')}
                </p>
                <p className="text-xl font-bold tracking-tight" style={{ color: 'var(--text)' }}>
                  {t('home_invest_min_val')}
                </p>
              </div>
              <div
                className="p-5 rounded-2xl border"
              ...
              >
                <p className="label-caps mb-2" style={{ color: 'var(--muted)' }}>
                  {t('home_invest_max_label')}
                </p>
                <p className="text-xl font-bold tracking-tight" style={{ color: 'var(--text)' }}>
                  {t('home_invest_max_val')}
                </p>
              </div>
            </div>
            ...
            <a
              ...
              style={{ background: 'var(--primary)', color: 'var(--primary-fg)' }}
            >
              {t('home_invest_cta')} <ArrowRight size={15} />
            </a>
            <p className="text-xs mt-4" style={{ color: 'var(--muted)' }}>
              {t('home_invest_contact')}
            </p>
          </div>
